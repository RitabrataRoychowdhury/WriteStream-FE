...
export default function LandingPage() {
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[hsl(220_30%_4%)] text-white">
      {/* Background video */}
      <video
        autoPlay
        loop
      ...
      <header className="relative z-20 flex items-center justify-between px-6 md:px-12 h-20">
        ...
        <nav className="hidden md:flex items-center gap-7 text-sm text-white/60">
          ...
          <Link to="/grafana" className="hover:text-white transition-colors">Grafana</Link>
